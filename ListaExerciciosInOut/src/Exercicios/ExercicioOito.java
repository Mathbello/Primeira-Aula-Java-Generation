...
public class ExercicioOito {
	public static void main(String args[]) {
		...
		System.out.printf("Qual o valor do veículo R$ ");
		...
		System.out.println("A taxa da concessionária é R$ " + taxaD);
		System.out.println("O custo real de fabricação é R$ " + custoF);
	}
